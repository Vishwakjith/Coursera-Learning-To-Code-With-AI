# Generating A Chrome Extension for Shopping List

## Creating a Basic Setup of Extension
...
When user saves the link, again when it is showed in the extension the link should be accessable.
